    ...
    <section>
      ...
      <div>
        <div>
          ...
          <aside className="my-8 policy rounded-md  py-20 px-8 border-2  border-[--tertiary-color] ">
            <p>
            ...
            <div className="lincense text-start">
              ...
              <h3 className="my-5">Here are terms of our Standard License:</h3>
      ...
      <div className="mt-28    ">
        <Image src={boy_standing_on_lock} alt="boy_standing_on_lock" />
      </div>
    </section>
  );
}
